    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_educativo', models.CharField(choices=[('TEC', 'Técnico'), ('TGL', 'Tecnólogo'), ('PRE', 'Pregrado'), ('ESP', 'Especialización'), ('MAE', 'Maestria'), ('DOC', 'Doctorado')], default='MAE', max_length=3)),
